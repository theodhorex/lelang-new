...
@endphp
<div class="row">
    <input type="text" name="" id="" style="background-color: #0E2930;" class="form-control cursor remove-focus placeholder border-0">
    <div class="col">
        <div class="row mt-3 @if(Auth::user()->role == 'user') d-none @endif">
            <div class="col">
                <div class="row me-2">
                    <div class="col-md-6 p-1">
                        <div class="card p-4 rounded" style="background-color: #0E2930;">
                            <h5 class="text-light fw-semibold">Recent activity</h5>
